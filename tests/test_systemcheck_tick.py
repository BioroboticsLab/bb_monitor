...
def pi(monkeypatch):
    ...
    monkeypatch.setattr(sc, "check_ping", lambda host, timeout_seconds=2: fake.reachable)
    return fake
...
def fleet(monkeypatch):
    ...
    monkeypatch.setattr(sc, "check_ping", lambda host, timeout_seconds=2: pis[host].reachable)
    return pis
