...
CAMS = [
    {"dir": "feedercamA", "label": "Feeder A"},
    {"dir": "feedercamB", "label": "Feeder B"},
    {"dir": "feedercamC", "label": "Feeder C"},
    {"dir": "feedercamD", "label": "Feeder D"},
]
WINDOW_DAYS          = 7
CACHE_DAYS           = 49
...
def load_cam_data(cam):
    parquet_files = sorted(glob.glob(
        f"{BASE_DIR}/*/{cam['dir']}/{cam['dir']}_*-detections-polo-c.parquet"
    ))
...
def draw_plot(fig, axes, save_path):
    ...
    fig.suptitle("Feeder Visits — Last 7 Days", fontsize=18, fontweight="bold")
...
if __name__ == "__main__":
    ...
    SAVE_PATH = "/home/beesbook/bb_monitor/figs/feeder_visits_plot.png"
